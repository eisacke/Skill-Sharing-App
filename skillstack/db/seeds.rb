...
c1 = Category.create(name: "Culinery", description: "Some cooking skills")
c2 = Category.create(name: "Technology", description: "Some tech skills")
c3 = Category.create(name: "Design", description: "Some design skills")
c4 = Category.create(name: "DIY", description: "Some DIY skills")